                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    if (empty($_POST['search']) and empty($_COOKIE['search'])) {
                                        ...
                                        $statement = $pdo->prepare("SELECT * FROM users ORDER BY id DESC LIMIT $offset,$numOfRecord");
                                        $statement->execute();
                                        ...
                                        $total_pages = ceil(count($rawResult) / $numOfRecord);
                                        $statement = $pdo->prepare("SELECT * FROM users WHERE name LIKE '%$search%' ORDER BY id DESC LIMIT $offset,$numOfRecord");
                                        $statement->execute();
                                        $result = $statement->fetchAll();
                                    }
                                    ?>
                                ...
                                <a href="user_add.php" class="btn btn-success mx-3 mb-3" type="button">Add new user</a>
                                <!-- /.card-body -->
                            </div>
                        </div>
                    </div>
